    ...
    <table>
        ...
        <tbody>
            @foreach ($customers as $index => $item)
                <tr>
                    ...
                    <td class="text-center">{{ \App\Utils\NumberUtil::formatQty($item->jumlah_transaksi) }}</td>
        ...
        <tfoot>
            <tr>
                ...
                <th class="text-center">{{ \App\Utils\NumberUtil::formatQty($customers->sum('jumlah_transaksi')) }}</th>
