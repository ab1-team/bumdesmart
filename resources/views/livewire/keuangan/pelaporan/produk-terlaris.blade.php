    ...
    <table>
        ...
        <tbody>
            @foreach ($products as $index => $item)
                <tr>
                    ...
                    <td class="text-center">{{ \App\Utils\NumberUtil::formatQty($item->total_terjual) }}</td>
        ...
        <tfoot>
            <tr>
                ...
                <th class="text-center">{{ \App\Utils\NumberUtil::formatQty($products->sum('total_terjual')) }}</th>
