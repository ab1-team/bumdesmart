    ...
    <table>
        ...
        <tbody>
            @foreach ($products as $index => $p)
                <tr>
                    ...
                    <td style="text-align: center;">{{ \App\Utils\NumberUtil::formatQtyFull($p->stok_awal_periode) }}</td>
                    <td style="text-align: center; color: green;">{{ \App\Utils\NumberUtil::formatQtyFull($p->stok_masuk) }}</td>
                    <td style="text-align: center; color: red;">{{ \App\Utils\NumberUtil::formatQtyFull($p->stok_keluar) }}</td>
                    <td style="text-align: center; font-weight: bold;">{{ \App\Utils\NumberUtil::formatQtyFull($p->stok_akhir) }}</td>
        ...
        <tfoot>
            <tr>
                ...
                <th style="text-align: center;">{{ \App\Utils\NumberUtil::formatQtyFull($summary['total_stok_akhir']) }}</th>
                <th></th>
