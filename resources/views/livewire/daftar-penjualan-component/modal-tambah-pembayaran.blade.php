            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="form-selectgroup w-100">
                            <label class="form-selectgroup-item flex-grow-1">
                                <input type="radio" name="payment_method_modal" value="cash"
                            ...
                            <label class="form-selectgroup-item flex-grow-1">
                                <input type="radio" name="payment_method_modal" value="transfer"
                                    class="form-selectgroup-input" x-model="metodePembayaran">
                                <span class="form-selectgroup-label">
                            ...
                            <label class="form-selectgroup-item flex-grow-1">
                                <input type="radio" name="payment_method_modal" value="qris"
                                    class="form-selectgroup-input" x-model="metodePembayaran">
                                <span class="form-selectgroup-label">
                    ...
                    <div class="col-md-12 mb-3" x-show="['transfer', 'qris'].includes(metodePembayaran)" x-transition>
                        ...
                        <div wire:ignore>
                            <select id="bankAccountSelectModal" class="form-select" x-model="noRekening" placeholder="Pilih Rekening Bank...">
                                <option value=""></option>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('tambahPembayaran', () => ({
                ...
                initBankSelect() {
                    ...
                    this.bankSelect = new TomSelect('#bankAccountSelectModal', {
                ...
                updateJumlah(e) {
                    // Indonesian format: digit + optional comma as decimal separator.
